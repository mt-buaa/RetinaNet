    ...
    for num,item in enumerate(jpg_list):
        ...
        with torch.no_grad():
            ...
            for x in predict_boxes:
                x[0] = x[0]+500*(num_pic%17)
                x[2] = x[2]+500*(num_pic%17)
                x[1] = x[1]+500*(num_pic//17)
                x[3] = x[3]+500*(num_pic//17)
